...
('F02', 'HN-DN', 'A02', '1500000', 30),
('F03', 'HCM-DN', 'A03', '1200000', 40),
('F04', 'HN-PQ', 'A04', '3000000', 20),
('F05', 'HCM-DL', 'A05', '1000000', 15);
...
update flights 
set available_seats = available_seats + 10 and ticket_price = ticket_price * 1.05
...
from bookings b
inner join passengers p on b.passenger_id = p.full_name
inner join flights f on b.flight_id = f.route_name
